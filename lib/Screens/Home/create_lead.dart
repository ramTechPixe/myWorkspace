...
class Create_lead extends StatefulWidget {
  const Create_lead({super.key});

  @override
  State<Create_lead> createState() => _Create_leadState();
}
              ...
              children: [
                ...
                Container(
                  ...
                  child: Obx(() {
                    return DropdownButtonFormField2<String>(
                      ...
                      items: dashboardController.allBusinees
                          .map((item) => DropdownMenuItem<String>(
                                value:
                                    item["projectName"], // Extract project name
                                child: Text(
                                  item["projectName"], // Show project name
                                  style: GoogleFonts.dmSans(
                                    fontSize: 14,
                                  ),
                                ),
                      ...
                      onChanged: (value) {
                        dashboardController.selectedProject.value =
                            value.toString();
                ...
                CustomButton(
                    ...
                    onTap: () {
                      ...
                      // };
                      var payload = {
                        "leadType": selectedUserValue,
                        // "leadFor": dashboardController.leadfor.text,
                        "bussinessType": dashboardController.leadfor.text,
                        "address": dashboardController.address.text,
                        // "bussinessType":
                        //     dashboardController.selectedProject.value,
                        "leadFor": dashboardController.selectedProject.value,
                        "mailId": dashboardController.createEmail.text,
                        "mobileNumber": dashboardController.issuemobile.text,
                        "bussinessName": dashboardController.issuename.text
                      };
